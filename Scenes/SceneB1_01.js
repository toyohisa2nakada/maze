...
SceneB1_01.prototype = new SceneB1_IntermediateBase();
SceneB1_01.prototype.maze = function(){
	return [
...
SceneB1_01.prototype.getScore = function(){
	return "A";
}
SceneB1_01.prototype.startScene = function(){
	this.super.startScene.call(SceneB1_01.prototype);
